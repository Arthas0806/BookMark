...
select emp.ename, dept.deptno, dname from emp, dept where emp.deptno = dept.deptno and ename = 'SCOTT'; 

--33. INNER JOIN과 ON 연산자를 사용하여 사원 이름과 함께 그 사원이 소속된 부서이름과 지역 명을 출력하시오.
select e.ename, d.dname, d.loc from emp e inner join dept d on e.deptno = d.deptno where e.ename = 'SCOTT'; 
...
select e.ename, e.empno, m.ename as "관리자"
from emp e, emp m
where e.mgr=m.empno
;
...
select e.ename, e.hiredate, m.ename as "관리자", m.hiredate as "입사일"
from emp e, emp m
