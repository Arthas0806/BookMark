...
public class PageController {
    ...
    public ModelAndView buyLog() {
        ModelAndView view = new ModelAndView();
        view.setViewName("views/product/buy_log");
        return view;
    }
 ...
 // 관리자 자유게시판 관리 목록 페이지
    ...
    public ModelAndView adminNoticeList() {
        ModelAndView view = new ModelAndView();
        view.setViewName("views/notice/adminNoticeList");
        return view;
    }
    ...
    public ModelAndView adminDetailNotice() {
        ModelAndView view = new ModelAndView();
    ...
    public ModelAndView adminModifyNotice() {
        ModelAndView view = new ModelAndView();
